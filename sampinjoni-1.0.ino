...
void setup() {
  ...
  lcd.begin(20, 4);
  lcd.backlight();
 // if( Ethernet.begin(_MAC_ADDRESS) != 1 ){
...
void sensorAction() {
 ...
 // co2DisplayOutput[6]  = trenutniCO2 / 1000 + 48;
 // co2DisplayOutput[7]  = (trenutniCO2 % 1000) / 100 + 48;
  //co2DisplayOutput[8]  = (trenutniCO2 % 100) / 10 + 48;
 // co2DisplayOutput[9] = trenutniCO2 % 10 + 48;
